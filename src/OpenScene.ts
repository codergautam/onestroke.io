...
class OpenScene extends Phaser.Scene {
   ...
   this.loadText =  this.add.text(0,0,"Loading").setOrigin(0.5,0.5);
      ...
      this.load.image("starYellow", "/assets/images/star-yellow.png");
      this.load.image("starGrey", "/assets/images/star-grey.png");
      this.load.image("starMedium", "/assets/images/star-medium.png");
